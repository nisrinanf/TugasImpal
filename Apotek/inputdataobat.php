        ...
        <!-- DataTables Example -->
		 ...
		 <div class="card card-register mx-auto mt-5">
		  ...
		  <?php
				...
				if($_SERVER['REQUEST_METHOD']=='POST'){
					...
					if(empty($arrayError)){
						...
						if (mysqli_num_rows($cek_data) < 1){
							$q = "INSERT INTO data_obat (id, kode_obat,nama_obat,harga_obat,stok_obat,date,status)
							VALUES('', '$kode_obat','$nama_obat','$harga_obat','$stok_obat',NOW(),'Ada')";
				...
				?>
            <form action="inputdataobat.php" method="post">
			  <div class="form-group">
				<div class="form-row">
				  <div class="col-md-6">
					<div class="form-label-group">
					  <input type="text" name="kode_obat" id="kode_obat" class="form-control" placeholder="Kode Obat" required="required" autofocus="autofocus" 
					  value="<?php if (isset($_POST['kode_obat'])) echo $_POST['kode_obat']; ?>" />
					  <label for="kode_obat">Kode Obat</label>
					</div>
				  </div>
				  <div class="col-md-6">
					<div class="form-label-group">
					  <input type="text" name="nama_obat" id="nama_obat" class="form-control" placeholder="Nama Obat" required="required"
					  value="<?php if (isset($_POST['nama_obat'])) echo $_POST['nama_obat']; ?>" />
			  ...
			  <div class="form-group">
				<div class="form-row">
				  <div class="col-md-6">
					<div class="form-label-group">
					  <input type="char" name="harga_obat" id="harga_obat" class="form-control" placeholder="Harga obat" required="required"
					  value="<?php if (isset($_POST['harga_obat'])) echo $_POST['harga_obat']; ?>"/>
					  <label for="harga_obat">Harga obat</label>
					</div>
				  </div>
				  <div class="col-md-6">
					<div class="form-label-group">
					  <input type="char" name="stok_obat" id="stok_obat" class="form-control" placeholder="Stok obat" required="required"
					  value="<?php if (isset($_POST['stok_obat'])) echo $_POST['stok_obat']; ?>" />
