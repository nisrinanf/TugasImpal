		 ...
		 <div class="card card-register mx-auto mt-5">
          ...
          <div class="card-body">
            <?php
				...
				if($_SERVER['REQUEST_METHOD']=='POST'){
					...
					if(mysqli_num_rows($cek_kode) < 1){
						...
						if (mysqli_num_rows($cek_data) < 1){
							...
							echo'<script type="text/javascript">alert("Kode Transaksi atau Obat Telah Digunakan");</script> ';
						}
					}
				...
				?>
            <form action="inputpenjualan.php" method="post">
		  ...
		  <input class="btn btn-primary btn-block" 
			 ...
			 <div class="text-center">
			<a class="d-block small mt-3" href="datapenjualan.php">Data Penjualan</a>
        </div>
          </div>
