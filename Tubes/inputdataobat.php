				...
				if($_SERVER['REQUEST_METHOD']=='POST'){
					...
					if(empty($arrayError)){
						...
						if (mysqli_num_rows($cek_data) < 1){
							$q = "INSERT INTO data_obat (kode_obat,nama_obat,harga_obat,stok_obat,date,status)
            ...
            <form action="inputdataobat.php" method="post">
			  ...
			  <div class="form-group">
				<div class="form-row">
				  <div class="col-md-6">
					<div class="form-label-group">
					  <input type="text" name="harga_obat" id="harga_obat" class="form-control" placeholder="Harga obat" required="required"
				  ...
				  <div class="col-md-6">
					<div class="form-label-group">
					  <input type="text" name="stok_obat" id="stok_obat" class="form-control" placeholder="Stok obat" required="required"
